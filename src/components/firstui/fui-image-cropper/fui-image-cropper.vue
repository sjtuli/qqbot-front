<!--本文件由FirstUI授权予上海交在科技有限公司（手机号：1590 0  7  3 3 60   4，身份证尾号：E8J88D）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
	<view class="fui-image__cropper" @touchmove.stop.prevent="stop">
		...
		<image @touchstart="touchstart" @touchmove="touchmove" @touchend="touchend" class="fui-cropper__img" :src="src"
							...
							this.ctx.toTempFilePath({
								...
								success: res => {
									...
									this.ctx.clearRect(0, 0, this.width * this
										.scaleRatio, this.width * this.scaleRatio);
									this.ctx.draw();
