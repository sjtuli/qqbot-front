<!--本文件由FirstUI授权予上海交在科技有限公司（手机号：1   59 0  073 3 6  04，身份证尾号：E8J88D）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
...
<script>
	...
	export default {
		...
		methods: {
			// #ifdef APP-NVUE
			_animation() {
				if (!this.$refs['fui_reupload'] || this.stop) return;
				animation.transition(
					this.$refs['fui_reupload'].ref, {
						styles: {
