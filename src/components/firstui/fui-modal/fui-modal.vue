<!--本文件由FirstUI授权予上海交在科技有限公司（手机号：  1 59  0  07 3 3 604，身份证尾号：E8J88D）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
	<view class="fui-modal__wrap" :style="{background:maskBackground,zIndex:zIndex}"
		...
		ref="fui_modal_ani">
		<view class="fui-modal__inner" :style="{width:width+'rpx',background:background,borderRadius:boxRadius+'rpx'}">
