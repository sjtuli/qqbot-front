<!--本文件由FirstUI授权予上海交在科技有限公司（手机号： 15 9007   336  0   4，身份证尾号：E8J88D）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
		...
		<view class="fui-picker__content"
			...
			<view class="fui-picker__header"
				...
				<text class="fui-picker__title"
					:class="[theme==='dark'?'fui-pk__title-color_dark':'fui-pk__title-color']" :style="titleStyl">{{title}}</text>
...
<style scoped>
	...
	/* #ifndef APP-NVUE*/
	.fui-picker__indicator::v-deep {
		position: relative;
		border-color: transparent;
	}

	.fui-picker__indicator::v-deep::before {
		border-color: #333;
	}

	.fui-picker__indicator::v-deep::after {
		border-color: #333;
	}
