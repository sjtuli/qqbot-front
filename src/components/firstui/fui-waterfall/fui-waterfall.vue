<!--本文件由FirstUI授权予上海交在科技有限公司（手机号：159  0 0 7  33  6  04，身份证尾号：E8J88D）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
	...
	export default {
		...
		methods: {
			...
			setWaterfallHeight(itemGap) {
				this.height = Math.ceil(Math.max(this.leftHeight, this.rightGap) + itemGap);
			},
			startSorting() {
